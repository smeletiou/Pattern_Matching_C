 ...
 * depending on the choise of the user each algorithm finds with different
...
int main(int argc, char *argv[])
{
  ...
  char *SeqTXT = (char *)malloc(sizeS); //creates a tab with the size of the file
  ...
  char *PatTXT = (char *)malloc(sizeP); //creates a tab with the size of the file
